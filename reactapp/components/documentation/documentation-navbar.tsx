...
export const DocumentationNavigation: React.FC<DocumentationNavigationProps> = ({ onCategorySelect }) => {
    ...
    const bouton_doc = "px-4 py-2 mx-2 bg-[#111827] dark:border border-white/10 shadow-md dark:shadow-foreground/5 rounded-lg text-white hover:bg-gradient-to-r from-blue-500 to-rose-600 transition-colors duration-300";
